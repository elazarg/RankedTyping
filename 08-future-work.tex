...
The bridge between graded and gradual typing is now partially built: \S\ref{sec:gradual-special-case} shows that gradual typing is a special case of graded typing, obtained by collapsing the grade successor. Remaining open directions: (i) a cast calculus with \emph{graded casts} (blame budgets) and a full blame/coherence meta-theory; (ii) a grade-indexed gradual guarantee; (iii) formally verifying the embedding in both directions.
